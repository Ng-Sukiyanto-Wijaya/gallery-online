...
<div class="w3-top">
  <div class="w3-bar w3-white w3-wide w3-padding w3-card">
    ...
    <div class="container"><br><br>
        <h1>Album Pemandangan</h1><br><br><br><br>
        <?php
    session_start();
...
<div class="photo-card">
    ...
    <div class="actions">
    <a href="like.php?fotoid=<?= $data['fotoid'] ?>"><i class="fa fa-thumbs-up"></i></a>
    <a href="komentar.php?fotoid=<?= $data['fotoid'] ?>"><i class="fa fa-comment"></i></a>
</div>
</div>
<?php
}
